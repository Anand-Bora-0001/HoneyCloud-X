...
def login():
    if request.method == "POST":
        ...
        if DEMO_USERS.get(email) == password:
            ...
            # Send audit telemetry to HoneyCloud-X
        ...
        # Send failed login telemetry to HoneyCloud-X
        ...
        # After 5+ failures, check if HoneyCloud-X recommends deception
        if attempt_count >= 5:
            logger.warning(
...
if __name__ == "__main__":
    ...
    print("\n🔐 Login Telemetry (sends events to HoneyCloud-X):")
