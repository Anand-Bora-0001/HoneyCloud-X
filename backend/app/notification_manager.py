...
from .models import NotificationConfig, AttackEvent, Organization
...
class NotificationManager:
    ...
    def send_alert(self, event: AttackEvent, organization: Organization):
    ...
    def _prepare_alert_message(self, event: AttackEvent, organization: Organization) -> Dict:
        ...
        try:
            ...
            payload = {
                "attachments": [{
                    ...
                    "footer": f"HoneyCloud | Event #{alert_data['event_id']}",
