...
from .models import Organization, User, Service, SubscriptionPlan, BillingHistory, AttackEvent
from .schemas import (
...
async def get_service_stats(
    ...
    events = db.query(AttackEvent).filter(
        AttackEvent.service_id == service_id,
