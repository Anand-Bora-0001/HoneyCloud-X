    ...
    def get_prometheus_metrics(self) -> str:
        ...
        if self.system_metrics_history:
            ...
            metrics_lines.extend([
                f'# HELP honeycloud_cpu_percent CPU usage percentage',
                f'# TYPE honeycloud_cpu_percent gauge',
                f'honeycloud_cpu_percent {latest.cpu_percent}',
                f'# HELP honeycloud_memory_percent Memory usage percentage',
                f'# TYPE honeycloud_memory_percent gauge',
                f'honeycloud_memory_percent {latest.memory_percent}',
                f'# HELP honeycloud_disk_usage_percent Disk usage percentage',
                f'# TYPE honeycloud_disk_usage_percent gauge',
                f'honeycloud_disk_usage_percent {latest.disk_usage_percent}',
                f'# HELP honeycloud_active_connections Active network connections',
                f'# TYPE honeycloud_active_connections gauge',
                f'honeycloud_active_connections {latest.active_connections}'
            ])
        
        # API metrics
        metrics_lines.extend([
            f'# HELP honeycloud_api_requests_total Total API requests',
            f'# TYPE honeycloud_api_requests_total counter',
            f'honeycloud_api_requests_total {self.counters["api_requests"]}',
            f'# HELP honeycloud_database_operations_total Total database operations',
            f'# TYPE honeycloud_database_operations_total counter',
            f'honeycloud_database_operations_total {self.counters["database_operations"]}'
        ])
        ...
        if self.websocket_metrics_history:
            ...
            metrics_lines.extend([
                f'# HELP honeycloud_websocket_connections WebSocket connections',
                f'# TYPE honeycloud_websocket_connections gauge',
                f'honeycloud_websocket_connections {{state="total"}} {latest_ws.total_connections}',
                f'honeycloud_websocket_connections {{state="active"}} {latest_ws.active_connections}',
                f'# HELP honeycloud_websocket_messages WebSocket messages',
                f'# TYPE honeycloud_websocket_messages counter',
                f'honeycloud_websocket_messages {{direction="sent"}} {latest_ws.messages_sent}',
                f'honeycloud_websocket_messages {{direction="received"}} {latest_ws.messages_received}'
            ])
